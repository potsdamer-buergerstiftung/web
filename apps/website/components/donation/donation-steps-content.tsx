  ...
  return (
    <div className="flex-1 flex flex-col gap-8">
      <Stepper.Content step="purpose">
        <PurposeStep generalPurposeAvailable={config.generalPurposeAvailable} items={projects.projects.map((project) => ({ id: project.id, title: project.title, description: project.sub_title }))} />
      </Stepper.Content>
