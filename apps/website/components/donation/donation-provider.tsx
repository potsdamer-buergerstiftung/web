...
import { DonationContext, DonationConfig, PaymentMethod } from "./donation-context";
...
function DonationStateProvider({ 
    ...
    return (
        <DonationContext.Provider value={{ config, projects: projectsState, paymentMethods: paymentMethodsState }}>
            {children}
