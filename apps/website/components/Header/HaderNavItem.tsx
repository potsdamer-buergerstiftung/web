  ...
  return (
    ...
    >
      <AnchorElement>
        ...
        <span
          className={clsx(
            "text-2xl font-bold text-slate-50 transition group-hover:text-primary group-focus:text-primary lg:text-[1rem] lg:font-medium lg:leading-6 lg:text-slate-900 dark:lg:text-slate-50",
          )}
        >
          {label}
        </span>
