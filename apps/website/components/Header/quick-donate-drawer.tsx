...
const QuickDonateForm = dynamic(() => import("./quick-donate-form"), {
    ssr: false,
    loading: () => (<div className="mx-auto h-full min-h-0 w-full max-w-5xl overflow-y-auto px-6 py-12 lg:col-span-2 lg:grid lg:grid-cols-subgrid lg:gap-x-10 lg:gap-y-8 lg:px-8">
