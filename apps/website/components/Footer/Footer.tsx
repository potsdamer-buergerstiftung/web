      ...
      <section>
        <div className="container mx-auto grid grid-cols-1 gap-16 px-4 pt-24 pb-16 md:grid-cols-2 lg:grid-cols-4 lg:gap-4">
          ...
          <div className="order-2 md:order-3 lg:order-2">
            <h4 className="font-header text-xl font-bold text-slate-900 dark:text-slate-50 md:text-lg">
              Komm uns besuchen
            </h4>
          ...
          <div className="order-3 md:order-4 lg:order-3">
            ...
            <h4 className="font-header mt-6 text-xl font-bold text-slate-900 dark:text-slate-50 md:text-lg">
              Ehrenamt
            </h4>
            <p className="mt-6">E-Mail</p>
            <a
          ...
          <div className="order-4 md:order-2 lg:order-4">
            ...
            <p className="mt-6 mb-4 font-bold text-slate-900 dark:text-slate-50">
