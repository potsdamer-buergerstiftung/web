  ...
  return (
    <>
      ...
      <p className="mt-4 mb-10">
        Wir benötigen diese Daten, damit du deine sich wiederholende Spende
        später ändern oder beenden kannst. Du kannst das jederzeit über den Link
        in der Bestätigungsmail tun, oder uns mit deinen Daten an uns wenden.
      </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <input
              ...
              onChange={(e) =>
                setCustomer({ ...customer, organization: e.target.value })
              }
              className="mt-2 w-full rounded-md border-none bg-slate-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500"
