...
import { donationProgressAtom, selectedProjectId } from "./state";
    ...
    return (
        <div className="grid grid-cols-3 gap-10">
            <div className="col-span-3">
                ...
                <p className="mt-2">Du kannst mit Deiner Spende ein <b>bestimmtes Projekt</b> oder die <b>allgemeine Arbeit</b> der Stiftung <b>unterstützen</b>.
                </p>
                ...
                <div className="mt-8 grid grid-cols-3 items-start justify-start gap-4">
                    ...
                    {projects && projects.map((project: any) => (
                        <button key={project.title} className="group relative block h-28 w-full cursor-pointer overflow-hidden rounded-lg" onClick={() => setProjectId(project.id)}>
                            <Image src={project.image} height="300" width="300" quality="40"
