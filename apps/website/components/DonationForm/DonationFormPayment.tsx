...
export default function DonationFormPayment({
  ...
  const [_donationProgress, setDonationProgress] =
  ...
  const onContinueClicked = async () => {
    ...
    if (selectedPaymentProviderId === bankTransferMethodId) {
      trackUmami("donation_bank_transfer_selected", {
    ...
    try {
      trackUmami("donation_payment_started", {
        amount: selectedAmount,
      ...
      console.error(error);
      trackUmami("donation_payment_failed", {
        amount: selectedAmount,
        method: selectedPaymentProviderId,
        duration,
      });
    ...
    <div className="grid grid-cols-3 gap-10">
      ...
      <div className="col-span-3 md:col-span-2">
          ...
          {paymentMethods &&
            paymentMethods.map((paymentMethod) => (
              <button
                ...
                data-umami-event={`donation_payment_method_${paymentMethod.id}`}
        ...
        <button
          ...
          data-umami-event="donation_payment_continue"
          className={clsx(
            ...
            (!selectedPaymentProviderId || !requiredChecked) &&
