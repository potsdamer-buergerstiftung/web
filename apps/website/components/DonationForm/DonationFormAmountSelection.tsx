  ...
  return (
    <div className="grid grid-cols-3 gap-10">
      ...
      <div className="col-span-3 md:col-span-2">
        <h1 className="font-header font-bold text-3xl">Betrag wählen</h1>
        <p className="mt-4">
          <b>Jeder Euro zählt.</b> Ab einer Spende von 50€ stellen wir Dir gerne
          ...
          {planDurations.map((planDuration, index) => (
            <li
              ...
              className={clsx(
                ...
                planDuration.key === activePlanDuration
                  ? "after:opacity-100"
                  : "after:opacity-0"
              )}
            >
              <button
                onClick={() => setActivePlanDuration(planDuration.key as any)}
              >
                {planDuration.text}
              </button>
            </li>
            ...
            <li
              ...
              className={clsx(
                ...
                amount === selectedAmount &&
                  defaultAmounts.includes(selectedAmount)
                  ? "after:opacity-100"
                  : "after:opacity-0"
              )}
            >
        ...
        <button
          ...
          className={clsx(
            ...
            !(selectedAmount > 1) && "opacity-50 cursor-not-allowed"
          )}
        >
          Weiter
        </button>
