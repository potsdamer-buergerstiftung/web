        ...
        <>
            {showBanner && (
                ...
                >
                    ...
                    <p className="text-sm text-foreground">Mehr Informationen findest du in unserer <Link href="/datenschutz" variant="link" className="px-0">Datenschutzerklärung</Link>.</p>
                    ...
                    <FieldGroup>
                        <Field orientation="horizontal" className="items-start">
                            ...
                            >
                                ...
                                <span className="text-xs text-muted-foreground font-normal leading-normal">
                                    Diese Cookies sind für die grundlegenden Funktionen der Website erforderlich und können nicht deaktiviert werden. Sie werden in der Regel nur als Reaktion auf von dir getätigte Aktionen gesetzt, wie z.B. das Festlegen deiner Datenschutzeinstellungen, das Einloggen oder das Ausfüllen von Formularen.
                                </span>
                            </Label>
                        </Field>
                        ...
                        <Field orientation="horizontal" className="items-start">
                            ...
                            >
                                ...
                                <span className="text-xs text-muted-foreground font-normal leading-normal">
                                    Hilft uns zu verstehen, wie die Website genutzt wird. Damit können wir unsere Website und Inhalte stetig verbessern.
                                </span>
                            </Label>
                        </Field>
                    </FieldGroup>
