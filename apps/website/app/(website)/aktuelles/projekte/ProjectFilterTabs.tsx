...
function FilterTabButton({
  ...
  return (
    <Link className="group font-bold font-header py-2 relative" href={href}>
      ...
      <span
        className={clsx(
          "absolute left-0 right-0 bottom-0 h-0.5 bg-emerald-500 transition",
    ...
    <ul className="flex flex-row flex-wrap gap-5 mt-10">
      <li>
        <FilterTabButton
          ...
          href="/aktuelles/projekte/laufend"
          label="Laufend"
        />
      </li>
      <li>
        <FilterTabButton
          ...
          href="/aktuelles/projekte/wiederkehrend"
          label="Wiederkehrend"
        />
      </li>
      <li>
        <FilterTabButton
          ...
          href="/aktuelles/projekte/in-planung"
          label="In Planung"
        />
      </li>
      <li>
        <FilterTabButton
          ...
          href="/aktuelles/projekte/abgeschlossen"
          label="Abgeschlossen"
        />
      </li>
    </ul>
