                ...
                <div
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        {category.publications.map((publication) => (
                            <ArticleCard key={publication.id} title={publication.title} date={new Date(publication.date_created)} projectTitle={publication.file.filename_download.split('.')[1].toUpperCase()}
