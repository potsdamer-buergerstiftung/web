      ...
      {events?.map((event: any) => (
        ...
        >
          <Link
            ...
            className="group relative block h-60 w-full cursor-pointer overflow-hidden rounded-lg bg-slate-200 dark:bg-slate-800"
          >
            <Image
            ...
            <div className="flex-column absolute top-0 bottom-0 left-0 right-0 flex items-end p-8">
              <div className="relative w-full">
                <h1 className="font-header text-2xl font-bold text-white">
                  {event.name}
                </h1>
