      ...
      <section>
        <div className="container mx-auto grid grid-cols-5 gap-8 px-4 pb-16">
          ...
          <div className="col-span-5 lg:col-span-3">
            <p>
              Der <b>Freundeskreis</b> besteht aus Menschen, die regelmäßig
              spenden und damit unsere gemeinnützige Arbeit für Potsdam stärken.
              Mit <b>100 Euro jährlich</b> sicherst du unser Fundament und
              ermöglichst eine langfristige, planbare Projektarbeit. Gemeinsam
        ...
        <div className="container mx-auto grid grid-cols-5 gap-8 px-4 py-16">
          ...
          <div className="col-span-5 lg:col-span-3">
            <p>
              ...
              tätigen und uns <b>mitteilen</b>, dass du{" "}
              <b>Pate werden möchtest</b>. Wir sind dankbar für dein Engagement
              und werden dafür sorgen, dass deine Spende gezielt eingesetzt
              wird, um positive Veränderungen in unserer Stadt zu bewirken. Wir
              werden nach Wunsch dein Engagement <b>öffentlich anerkennen</b>{" "}
              und unsere Plattform nutzen, um die <b>Wirkung</b> deiner
              Patenschaft <b>zu kommunizieren</b>.
            </p>
          </div>
        </div>
      </section>
