      ...
      <section className="bg-white">
        <div className="container mx-auto grid grid-cols-8 gap-x-8 gap-y-12 px-4 pb-16">
          <div className="col-span-8 lg:col-span-2">
            ...
            <p className="mt-3">
              Mit Deiner Spende die Zukunft Deiner Stadt formen
            </p>
          </div>
          ...
          <div className="col-span-8 md:col-span-4 lg:col-span-3">
            ...
            <p className="mt-4">
              IBAN: <b>DE93 1207 0000 0010 6633 00</b>
            </p>
            <p>
              BIC: <b>DEUTDEBB160</b>
            </p>
        ...
        <div className="container mx-auto grid grid-cols-8 gap-x-8 gap-y-12 px-4 py-16">
          ...
          <div className="col-span-8 md:col-span-4 lg:col-span-3">
            <p>
              ...
              <b> regelmäßigen und verlässlichen Unterstützung</b> können wir
              diese wichtigen Voraussetzungen schaffen.
            </p>
            <Link
              href="/mitstiften/freundeskreis"
              className="group mt-6 inline-flex items-center rounded-md text-base font-bold text-slate-900 transition hover:text-emerald-500"
      ...
      <section className="bg-white">
        <div className="container mx-auto grid grid-cols-8 gap-x-8 gap-y-12 px-4 py-16">
          <div className="col-span-8 lg:col-span-2">
            ...
            <p className="mt-3">
              Sie wünschen sich ein Förderprojekt mit Bezug zu Ihrer Branche
              oder Ihrem Unternehmen?
            </p>
          </div>
          <div className="col-span-8 md:col-span-4 lg:col-span-3">
            <p>
              Gesellschaftliche <b>Verantwortung übernehmen</b>, die
              Verbundenheit mit dem Firmenstandort zum Ausdruck bringen, jungen
              Menschen durch wichtige Impulse den Weg in eine freie und
              lebenswerte Stadt ebnen - es gibt viele gute Gründe, als{" "}
              <b>Potsdamer Unternehmen</b> die Arbeit der Bürgerstiftung zu
              fördern.
            </p>
            <Link
              href="/mitstiften/freundeskreis"
          ...
          <div className="col-span-8 md:col-span-4 lg:col-span-3">
            <p>
              Gern schlagen wir Ihnen <b>passende Förderbereiche</b> oder
              Projekte für zweckgebundene Spenden vor.
              <b>Unterstützen Sie mit uns Ihre Projektidee</b> oder finden Sie
              mit unseren Projekten ein <b>passendes Engagement</b> für Ihr
              Unternehmen.
            </p>
            <Link
              href="/mitstiften"
