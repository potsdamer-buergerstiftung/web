                ...
                <div className="mx-auto max-w-3xl px-4 pb-24 text-center lg:pb-32">
                    <div className="grid grid-cols-1 gap-16 md:grid-cols-3 md:gap-8">
                        <div>
                            ...
                            <h4 className="pt-3 font-bold uppercase tracking-widest">E-Mail</h4>
                        ...
                        <div>
                            ...
                            <h4 className="pt-3 font-bold uppercase tracking-widest">Instagram</h4>
                        ...
                        <div>
                            ...
                            <h4 className="pt-3 font-bold uppercase tracking-widest">Telefon</h4>
