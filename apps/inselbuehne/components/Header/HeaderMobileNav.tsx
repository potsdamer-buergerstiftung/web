...
export default function HeaderMobileNav() {
    ...
    return (
        <div
            className={clsx("fixed top-0 bottom-0 left-0 right-0 z-30 -translate-x-full overflow-hidden overscroll-contain bg-white transition duration-500 ease-in-out lg:hidden", {
        ...
        >
            <div className="container mx-auto flex flex-col px-2 pt-44">
                ...
                />
                <HeaderNavItem label="Über uns" href="https://www.potsdamer-buergerstiftung.org" />
                <HeaderNavItem
                    label="Spenden"
